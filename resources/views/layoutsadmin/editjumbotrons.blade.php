        ...
        <div class="card-header">
            <div class='ml-3 mt-3 mr-3'>
                <div class="card card-primary">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Edit  "{{$postjumbotron->title}}"  Jumbotron</h3>
                    </div>

                    <form role="form" action='/flatjumbotrons/{{$postjumbotron->id}}' method='post' enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name='title' value="{{old('title', $postjumbotron->title)}}" placeholder="Enter the Title..." required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="sentence" id="sentence" class="form-control" cols="30" rows="3" placeholder="Fill the Sentence for Thumbnail..." value="{{old('sentence', '')}}" required>{{$postjumbotron->sentence}}</textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="buttonname" name='buttonname' value="{{old('buttonname', $postjumbotron->btnname)}}" required placeholder="Enter the Button Name like 'More', 'Go', 'Contact Us' etc OR ignore it if you don't want to fill it...">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="buttonlink" name='buttonlink' value="{{old('buttonlink', $postjumbotron->btnlink)}}" required placeholder="Enter the Button Link like 'https://www.instagram.com/flatuinjakarta/' etc OR ignore it if you don't want to fill it...">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="picture" name = 'picture' value="{{old('picture', $postjumbotron->picture)}}" required>
                                <div class="invalid-feedback">
