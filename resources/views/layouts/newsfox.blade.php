		...
		<div class="row">
          ...
          {{-- <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('{{asset('uploads/news/1616021961 . demo 2.jpg')}}');">
            ...
            <div class="col-md-6 col-lg-4 ftco-animate">
                <div class="blog-entry">
                    <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('/uploads/news/{{$post->picture}}');">
				        <div class="meta-date text-center p-2">
